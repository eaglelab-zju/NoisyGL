...
You can customize the combination of method, data, noise type, and noise rate by changing the corresponding parameters.
...
By running this command, the detailed experiment information will be printed on the terminal, and you can use this information to locate the problem.
...
by changing the parameter --method, --data, --noise_type and --noise_rate. 
